...
import project2 from "../Components/SocialLinks/Sentiment Analysis.jpg"
import project3 from "../Components/SocialLinks/Security.jpg"
          ...
          <a href="#">
            ...
            >
              ...
              <div>
                ...
                <h1 className={`text-md font-bold ${bgcolor==="white" ? "text-black" :"text-white"}`}>Sentimental Analysis Of Restaurant Reviews (Python, Data Analysis)</h1>
              </div>
            </div>
            </a>
            <a href="#">
            ...
            >
              ...
              <div>
                ...
                <h1 className={`text-md font-bold ${bgcolor==="white" ? "text-black" :"text-white"}`}>Security Of IOT Device Data Using ML (Python, Jupyter, ML Algos, Streamlit)</h1>
              </div>
            </div>
            </a>
          </div>
