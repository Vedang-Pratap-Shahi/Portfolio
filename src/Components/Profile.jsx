...
import Vedang from "../Components/SocialLinks/Vedang.jpg";
import "../Components/Global.css";
import cv from "../Components/SocialLinks/Vedang Resume.pdf";
      ...
      <div className="w-full flex justify-around">
        ...
        >
          <div className="w-40 h-40 rounded-full  image">
            <img src={Vedang} className="w-screen rounded-lg" />
          </div>
          <h1
          ...
          <div className=" w-96 p-2 flex gap-2 justify-center relative lg:top-10 sm:top-14">
            ...
            >
              <a href="https://x.com/VedangShahi" target="#">
                {" "}
            ...
            >
              <a href="https://www.linkedin.com/in/vedang-pratap-shahi-2b4081230/">
                {" "}
            ...
            >
              <a href="https://github.com/Vedang-Pratap-Shahi" target="#">
                {" "}
